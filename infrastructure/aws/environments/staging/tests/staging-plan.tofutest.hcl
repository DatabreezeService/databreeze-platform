...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/iam/service-account-envelope-key-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/iam/email-verification-digest-key-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/iam/email-verification-envelope-key-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/iam/registration-admission-key-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/iae/worker-capability-signing-key-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/worker/service-account-bearer-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/database-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/csrf-allowed-origins-AbCdEf"
  }
}
...
override_resource {
  ...
  values = {
    arn = "arn:aws:secretsmanager:ap-southeast-1:123456789012:secret:databreeze/staging/openai/api-key-AbCdEf"
  }
}
...
run "api_runtime_secret_contract" {
  ...
  assert {
    ...
    error_message = "The staging API task definition must map exactly the two runtime names to their dedicated whole-secret ARNs."
  }
  ...
  assert {
    ...
    error_message = "The staging API execution policy must grant GetSecretValue only for the two runtime secret ARNs."
  }
  ...
  assert {
    ...
    error_message = "The staging API KMS policy must be restricted to Secrets Manager and both runtime secret encryption contexts."
  }
}
...
run "openai_feature_contract" {
  ...
  assert {
    condition = jsondecode(module.compute.api_task_definition_container_definitions)[0].environment == [
      ...
      { name = "DATABREEZE_IAE_ARTIFACT_BUCKET", value = "databreeze-staging-artifacts" },
    ...
    error_message = "Staging must render bounded non-secret OpenAI configuration for the API parser."
  }
  ...
  assert {
    ...
    error_message = "Staging must pass the dedicated whole-secret ARN to the API task and exact execution policy."
  }
}
