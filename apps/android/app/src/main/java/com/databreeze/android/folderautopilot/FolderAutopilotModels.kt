...
data class FolderAutopilotApprovalSummary(
    ...
    fun decide(next: FolderAutopilotApprovalDecision, expectedPlanHash: String): FolderAutopilotApprovalSummary {
...
data class FolderAutopilotMobileState(
    ...
    ): FolderAutopilotMobileState = copy(approval = approval.decide(decision, expectedPlanHash))
