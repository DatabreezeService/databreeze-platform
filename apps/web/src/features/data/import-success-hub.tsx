...
function copy(locale: 'en' | 'vi-VN') {
  return locale === 'vi-VN'
    ? {
        ...
        subtitle: 'Dữ liệu đã được chuẩn hóa thành phiên bản bất biến và có thể dùng ngay trong Phân tích.',
        ...
        dashboardUnavailable: 'Chưa có mẫu biểu đồ an toàn cho cấu trúc dữ liệu này. Bạn vẫn có thể phân tích dữ liệu hoặc tạo biểu đồ sau.',
    ...
    : {
        ...
        dashboardUnavailable: 'No safe starter template matches this dataset yet. You can still analyze it or add charts later.',
    ...
    <section className="import-success-hub" aria-label={text.title}>
      ...
      <div className="import-success-actions">
        ...
        {dashboardStatus === 'READY' && starterDashboardId !== undefined ? (
          <a
            href={`/${locale}/dashboards?dashboard=${encodeURIComponent(starterDashboardId)}`}
