...
export function RegisterPage({
  ...
  return (
    <AuthPageShell
      ...
      description={isVi ? 'Tạo không gian riêng và xác minh email để tiếp tục.' : 'Create your workspace and verify your email to continue.'}
      footer={
        <p>
    ...
    >
      <form className="auth-form" onSubmit={(event) => void submit(event)}>
        ...
        <div className="auth-form__hint-box">
          <svg className="auth-form__hint-icon" width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
