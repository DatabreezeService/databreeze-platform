...
void test('generates deterministic versioned OpenAPI with safe headers, errors, validation, and operational paths', async () => {
  ...
  try {
    ...
    assert.deepEqual(paths, [
      ...
      '/v1/auth/sign-in',
      '/v1/auth/sign-out',
      '/v1/autopilot-approvals/{approvalId}/decision',
      '/v1/autopilot-assignments',
      '/v1/autopilot-assignments/{assignmentId}',
      '/v1/autopilot-assignments/{assignmentId}/pause',
      '/v1/autopilot-dashboard',
      '/v1/autopilot-executions/{executionId}/undo',
      '/v1/autopilot-folder-bindings',
      '/v1/autopilot-folder-bindings/{bindingId}',
      '/v1/autopilot-profiles',
      '/v1/autopilot-profiles/{profileId}',
      ...
      '/v1/spreadsheet-audit-runs',
      '/v1/spreadsheet-audit-runs/{runId}',
