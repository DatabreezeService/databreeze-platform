...
const input = {
  ...
  tenantScope: { scopeType: 'workspace', organizationId, workspaceId },
  schemaVersionId: '00000000-0000-4000-8000-000000000022',
  createdAt: '2026-01-01T00:00:00.000Z',
  canonicalHash: 'a'.repeat(64),
  rules: [
    {
      ruleId: '00000000-0000-4000-8000-000000000023',
      fieldId: '00000000-0000-4000-8000-000000000024',
      kind: 'REQUIRED',
      severity: 'ERROR',
    },
  ],
...
void test('[DSM-009] missing rule-set versions return a stable application error', async () => {
  ...
  const result = await service.publish(
    ...
    stable('00000000-0000-4000-8000-000000000026'),
