...
export type AutomaticPreparationRouteV1 =
  | { readonly kind: 'ENQUEUE_ACCEPTED_JOB'; readonly classification: AutomaticPreparationClassificationV1 }
  | { readonly kind: 'ETL_REVIEW'; readonly classification: AutomaticPreparationClassificationV1 }
  | { readonly kind: 'BLOCKED_REVIEW_ITEM'; readonly classification: AutomaticPreparationClassificationV1 };
...
export class AutomaticPreparationService {
  public classifyAndRoute(
    ...
    const classification = classifyAutomaticPreparation(plan, profile);
