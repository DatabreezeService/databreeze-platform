...
export class MappingController {
  ...
  async create(@Req() request: unknown, @Param('datasetId') datasetIdInput: string, @Body() input: CreateMappingDto): Promise<unknown> {
    ...
    return this.mappings.create(context, { ...input, datasetId: datasetId.value, tenantScope: context.tenantScope });
  }
