...
export type MappingServiceResultV1<TValue> = MappingResultV1<TValue> | { readonly accepted: false; readonly code: MappingServiceErrorV1 };

export class MappingService {
  public constructor(private readonly repository: MappingRepositoryPortV1) {}

  public async create(context: IamTenantContextV1, input: Parameters<typeof createMappingDefinitionV1>[0]): Promise<MappingServiceResultV1<MappingDefinitionV1>> {
  ...
  public async publish(context: IamTenantContextV1, versionId: StableIdentifierV1, nextVersionIdInput: unknown, publishedAt: unknown): Promise<MappingServiceResultV1<MappingDefinitionV1>> {
    return this.repository.withTransaction(context, async (transaction) => {
