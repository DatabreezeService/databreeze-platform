...
const vietnameseCatalogV1 = {
  ...
  'api.error.device_unavailable': entry('Thiết bị hiện không khả dụng.'),
  'api.error.device_not_found': entry('Không tìm thấy thiết bị.'),
  'api.error.device_request_rejected': entry('Thiết bị đã từ chối yêu cầu.'),
  'api.error.device_revision_conflict': entry('Thiết bị đã thay đổi. Hãy tải lại và thử lại.'),
  'api.error.device_scope_denied': entry('Bạn không có quyền truy cập thiết bị này.'),
  'api.error.invitation_request_rejected': entry('Lời mời không hợp lệ hoặc đã bị từ chối.'),
  'api.error.invitation_scope_denied': entry('Bạn không có quyền quản lý lời mời này.'),
  'api.error.invitation_not_found': entry(
    'Không tìm thấy lời mời hoặc bạn không có quyền truy cập.',
  ),
  'api.error.invitation_conflict': entry('Lời mời đã thay đổi hoặc đã được sử dụng.'),
  'api.error.invitation_delivery_unavailable': entry('Không thể gửi lời mời lúc này.'),
  'api.error.invitation_unavailable': entry('Dịch vụ lời mời hiện không khả dụng.'),
...
const englishCatalogV1: MessageCatalogV1 = {
  ...
  'api.error.device_unavailable': entry('The device is temporarily unavailable.'),
  'api.error.device_not_found': entry('The device was not found.'),
  'api.error.device_request_rejected': entry('The device rejected the request.'),
  'api.error.device_revision_conflict': entry('The device changed. Reload and try again.'),
  'api.error.device_scope_denied': entry('You do not have access to this device.'),
  'api.error.invitation_request_rejected': entry('The invitation is invalid or was rejected.'),
  'api.error.invitation_scope_denied': entry(
    'You do not have permission to manage this invitation.',
  ),
  'api.error.invitation_not_found': entry('The invitation was not found or is not accessible.'),
  'api.error.invitation_conflict': entry('The invitation changed or has already been used.'),
  'api.error.invitation_delivery_unavailable': entry(
    'The invitation could not be delivered right now.',
  ),
  'api.error.invitation_unavailable': entry('The invitation service is temporarily unavailable.'),
  ...
  'api.error.recovery_unavailable': entry('The recovery service is temporarily unavailable.'),
  'module.folderAutopilot': entry('Folder Autopilot'),
  'module.spreadsheetAuditor': entry('Spreadsheet Auditor'),
  'module.quoteIntelligence': entry('Quote Intelligence'),
  'module.operationsCapture': entry('Operations Capture'),
