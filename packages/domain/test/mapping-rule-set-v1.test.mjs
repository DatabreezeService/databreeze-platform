...
void test('[DSM-007, DSM-008] mappings are bounded, declarative, and publish as immutable versions', () => {
  const input = {
    ...
    steps: [
      {
        sourceFieldId: '00000000-0000-4000-8000-000000000014',
        targetFieldId: '00000000-0000-4000-8000-000000000015',
        transform: 'LOOKUP',
        lookupVersionId: '00000000-0000-4000-8000-000000000016',
      },
    ],
  ...
  const published = publishMappingDefinitionV1(
    created.value,
  ...
  assert.deepEqual(
    createMappingDefinitionV1({ ...input, steps: [{ ...input.steps[0], transform: 'LOOKUP' }] }),
    created,
  );
});
...
void test('[DSM-007] mappings reject duplicate targets and executable transforms', () => {
  const base = {
    ...
    tenantScope: scope,
    sourceSchemaVersionId: '00000000-0000-4000-8000-000000000022',
    targetSchemaVersionId: '00000000-0000-4000-8000-000000000023',
    createdAt: '2026-01-01T00:00:00.000Z',
  ...
  assert.deepEqual(
    createMappingDefinitionV1({
      ...
      steps: [
        {
          sourceFieldId: '00000000-0000-4000-8000-000000000024',
          targetFieldId: '00000000-0000-4000-8000-000000000025',
          transform: 'IDENTITY',
        },
        {
          sourceFieldId: '00000000-0000-4000-8000-000000000026',
          targetFieldId: '00000000-0000-4000-8000-000000000025',
          transform: 'IDENTITY',
        },
      ],
      ...
      steps: [
        {
          sourceFieldId: '00000000-0000-4000-8000-000000000024',
          targetFieldId: '00000000-0000-4000-8000-000000000025',
          transform: 'EXECUTE_SCRIPT',
        },
      ],
    }),
    { accepted: false, code: 'INVALID_STEP' },
  );
});
...
void test('[DSM-009, DSM-010, DSM-011] rule sets accept only typed deterministic parameters', () => {
  const input = {
    ...
    tenantScope: scope,
    schemaVersionId: '00000000-0000-4000-8000-000000000032',
    createdAt: '2026-01-01T00:00:00.000Z',
    canonicalHash: 'c'.repeat(64),
    rules: [
      {
        ruleId: '00000000-0000-4000-8000-000000000033',
        fieldId: '00000000-0000-4000-8000-000000000034',
        kind: 'REQUIRED',
        severity: 'ERROR',
      },
      {
        ruleId: '00000000-0000-4000-8000-000000000035',
        fieldId: '00000000-0000-4000-8000-000000000036',
        kind: 'RANGE',
        severity: 'WARNING',
  ...
  assert.deepEqual(
    createRuleSetDefinitionV1({
      ...input,
      rules: [{ ...input.rules[0], parameters: { script: 'drop table' } }],
    }),
    { accepted: false, code: 'INVALID_PARAMETERS' },
  );
});
